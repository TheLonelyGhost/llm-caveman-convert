...
The `caveman` binary is the CLI tool for compressing plain English to caveman-speak and decompressing caveman-speak back to plain English. It wraps the compressor LLM, maintains persistent encode/decode caches, and is invoked as a subprocess by the proxy.
...
#### Scenario: Encode passes all fenced code blocks verbatim
...
#### Scenario: Encode contracts redundant phrasing
