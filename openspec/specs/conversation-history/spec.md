...
Governs how multi-turn conversation history is stored and transmitted. History is stored in compressed (caveman-speak) form to enable provider prefix-cache hits and minimize token usage.
