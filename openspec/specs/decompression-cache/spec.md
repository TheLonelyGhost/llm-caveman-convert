...
Persistent cache for decompression (decode) results inside the `caveman` binary. Maps a deterministic hash of compressed caveman-speak input to its expanded plain English output, avoiding redundant decompressor LLM calls.
