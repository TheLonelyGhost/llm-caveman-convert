...
Defines how the proxy compresses individual user messages before forwarding to the backend. Compression is delegated entirely to the `caveman` binary subprocess; the proxy treats messages as opaque strings.
